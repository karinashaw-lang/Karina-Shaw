...
87 recorded sources.** Not few — none. Every finding in this repo rests on agency
...
**Faithful republisher** — codes.findlaw.com (6), law.justia.com (3), california.public.law (2), courtlistener.com (2), law.cornell.edu (1)
...
| `partial` | 16 |
| `secondary-only` | 8 |
| `unverifiable-as-recorded` | 4 |

**These carry the Winet shape:**

- `ea_ca_925` — asserts something is void or voidable; states a legal test; 3 secondary and 0 mirror source(s), no primary
...
- `msa_ca_925` — asserts something is void or voidable; 2 secondary and 1 mirror source(s), no primary
