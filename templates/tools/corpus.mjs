...
export function loadCorpus(){
  ...
  const partyRoles = read('schemas/party-roles.json');
  ...
  return {taxonomy, rules:rulesFile.rules, glossary:glossary.terms,
          documents:documents.documents, fields:fields.fields, aliases:aliases.aliases, questions:questions.questions, risks:risks.risks, benchmarks:benchmarks.benchmarks, benchmarkSchema:benchmarks, templateMeta, partyRoles:partyRoles.rules, clauses, sources, files};
}
export {ROOT};
